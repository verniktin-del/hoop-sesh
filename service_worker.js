...
const urlsToCache = [
  ...
  'https://www.gstatic.com/firebasejs/9.23.0/firebase-auth-compat.js',const CACHE_NAME = 'hoops-cache-v9';
const urlsToCache = [
  './',
  './index.html',
  './admin-standalone.html',
...
self.addEventListener('message', event => {
  ...
  if (event.data && event.data.action === 'skipWaiting') {
    console.log('[SW] Skip waiting requested by user - activating now');
    self.skipWaiting();
  }
